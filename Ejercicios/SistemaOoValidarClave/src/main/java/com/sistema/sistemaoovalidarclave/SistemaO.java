...
public class SistemaO {
    ...
    Scanner leer = new Scanner(System.in);
        ...
        clave=leer.nextInt();
         ...
         if (clave != 1234) {
            System.out.println("Â¡Clave incorrecta x_x!");
        }
         } while (clave != 1234);
         
         ValidarClave key = new ValidarClave ();
        
        System.out.println("//SeÃ±or "+nombre);
        System.out.println("Su clave es: "+ clave+"\n");
        
        
    
        System.out.println("-------------------------------------------");
        System.out.println("| *Si desea cambiar su contraseÃ±a ");
        ...
        System.out.println("---------------------");
        System.out.println("SeÃ±or "+key.getNombre());
